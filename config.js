...
module.exports = {
    ...
    MONGODB_URI: process.env.MONGODB_URI || 'mongodb+srv://teamredxhacker_db_user:fqSuhbBcRSrqX78q@muzamil2008.panreux.mongodb.net/?appName=muzamil2008',
    
    // ===========================================================
    // 2. INFORMATIONS DU BOT
    // ===========================================================
    PREFIX: process.env.PREFIX || '.',
    OWNER_NUMBER: process.env.OWNER_NUMBER || '923183928892', // Mettez votre numéro ici
    BOT_NAME: "MUZAMIL-XMD",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ muzamil khan',
    ...
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://whatsapp.com/channel/0029VbCkm3rAe5VzCYLtNb2u',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://h.uguu.se/uKDWRzNs.jpg',
